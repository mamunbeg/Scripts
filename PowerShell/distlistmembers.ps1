...
Get-ADGroup -Filter 'GroupCategory -eq "Distribution" -and GroupScope -ne "DomainLocal"' | Sort Name | Select Name, Description | Export-Csv $folderpath\adGroupList.csv
